...
public final class AddEnchantedBookLootModifier extends LootModifier {

    public static final Supplier<Codec<AddEnchantedBookLootModifier>> CODEC = Suppliers.memoize(() -> RecordCodecBuilder.create(instance -> codecStart(instance).and(
    ...
    private AddEnchantedBookLootModifier(LootItemCondition[] conditionsIn, List<Addition> additions) {
        super(conditionsIn);
    ...
    protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        for (Addition addition : additions) {
            if (NConfig.ENABLE_SEARING.get() && (context.getRandom().nextFloat() <= addition.chance)) {
