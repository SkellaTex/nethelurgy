package net.skellatex.nethelurgy.content.potion;
...
public class NMobEffects {
    ...
    public static final DeferredRegister<MobEffect> MOB_EFFECTS = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, Nethelurgy.MOD_ID);
    public static final DeferredRegister<Potion> POTIONS = DeferredRegister.create(ForgeRegistries.POTIONS, Nethelurgy.MOD_ID);

    public static final RegistryObject<Potion> DECAY_POTION = POTIONS.register("decay", () -> new Potion(new MobEffectInstance(MobEffects.WITHER, 900)));
    public static final RegistryObject<Potion> LONG_DECAY_POTION = POTIONS.register("long_decay", () -> new Potion(new MobEffectInstance(MobEffects.WITHER, 1800)));
    public static final RegistryObject<Potion> STRONG_DECAY_POTION = POTIONS.register("strong_decay", () -> new Potion(new MobEffectInstance(MobEffects.WITHER, 420, 1)));
